...
namespace RetailEdiGateway.Application.Features.Campaigns.Queries
{
 /// <summary>
 /// Query to retrieve the dashboard overview of all campaigns and their metrics.
 /// </summary>
 ...
 /// <summary>
 /// Data Transfer Object representing the dashboard summary of a campaign.
 /// </summary>
 ...
 /// <summary>
 /// Gets or sets the start date of the campaign in stores.
 /// </summary>
 ...
 /// <summary>
 /// Handles the retrieval and projection of all campaigns and their dashboard metrics.
 /// </summary>
